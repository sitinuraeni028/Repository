...
<body>
     <div align="center">
        <div width="500" border="0" cellpadding="1" cellspacing="0">
            <tr>
                <th>Toko NENI <br>
                JL Sukasirna <br>
                cisuta,bunijaya</th>
        ...
        <table width="500" border="0" cellpadding="3" cellspacing="0">
            ...
            <tr>
                ...
                <td align="right"><?=number_format($trx['bayar'])?></td></td>
            </tr>
            <tr>
                <td align="right" colspan="3">Kembali</td>
                <td align="right"><?=number_format($trx['kembali'])?></td></td>
            </tr>
        </table>
