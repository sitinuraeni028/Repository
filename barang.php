            ...
            <table class="table table-bordered bg-white">
                ...
                while ($row = $view->fetch_array()) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="barang_edit.php?id=<?= $row['id_barang'] ?> " class="btn btn-primary">Edit</a> |
                            <a href="barang_hapus.php?id=<?= $row['id_barang'] ?>" class="btn btn-primary" onclick="return confirm('apakah anda yakin?')">Hapus</a>
                        </td>
                    </tr>
