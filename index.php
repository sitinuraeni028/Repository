...
<div class="container">
    ...
    <a href="barang.php" class="btn btn-primary">Barang</a> | <a href=" role.php" class="btn btn-primary"> Role </a> | <a href=" user.php" class="btn btn-primary">User</a> | <a href=" logout.php" class="btn btn-primary">Logout</a> |
</div>
</body>
